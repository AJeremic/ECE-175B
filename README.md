This project was to create a VAE in pytorch, here I used a small dataset of only a few thousand images of size 256x256. The number of pixels greatly outweighs the number of training images, often this
